		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "仕訳連携IF実行",
									"targetURL": "#journalentryiflauncher-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"journalentryiflauncher-display": {
								"semanticObject": "journalentryiflauncher",
								"action": "display",
								"description": "仕訳連携IF実行用アプリケーション",
								"title": "仕訳連携IF実行",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=journalentryiflauncher",
									"url": sap.ui.require.toUrl("journalentryiflauncher")
								}
							}
						}
					}
